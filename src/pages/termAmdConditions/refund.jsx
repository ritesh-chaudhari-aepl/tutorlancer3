...
const Refund = () => {
  return (
    <div className='p-4 max-w-screen-2xl mx-auto min-h-screen'>
       <a className="my-12 inline-block cursor-pointer rounded-full bg-gradient-to-r from-pink-darkPink to-blue-light px-8 py-4 text-sm font-medium text-white transition hover:bg-indigo-700 capitalize" href="/">Back to Home</a>
